...
using day07DataAccess.Models;

namespace day07DataAccess.Controllers
{
    public class CtHoaDonsController : Controller
    {
        private readonly QlbhContext _context;

        public CtHoaDonsController(QlbhContext context)
        {
            _context = context;
        }
        ...
        {
            var qlbhContext = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
