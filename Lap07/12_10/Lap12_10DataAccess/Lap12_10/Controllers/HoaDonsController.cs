...
namespace Lap12_10.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        {
            var qlbanHangContext = _context.HoaDons.Include(h => h.MaKhachHangNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,MaHoaDon,MaKhachHang,NgayHoaDon,NgayNhan,HoTenKhachHang,Email,DienThoai,DiaChi,TongTienGia,TrangThai")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaHoaDon,MaKhachHang,NgayHoaDon,NgayNhan,HoTenKhachHang,Email,DienThoai,DiaChi,TongTienGia,TrangThai")] HoaDon hoaDon)
        {
            if (id != hoaDon.Id)
            {
                return NotFound();
