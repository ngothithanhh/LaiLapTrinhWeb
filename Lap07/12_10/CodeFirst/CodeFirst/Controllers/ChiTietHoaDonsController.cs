...
namespace CodeFirst.Controllers
{
    public class ChiTietHoaDonsController : Controller
    {
        ...
        {
            var appDbContext = _context.ChiTietHoaDons.Include(c => c.HoaDon);
        ...
        public async Task<IActionResult> Create([Bind("Id,HoaDonId,MaSanPhamId,SoLuongMua,DonGiaMua,ThanhTien")] ChiTietHoaDon chiTietHoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HoaDonId,MaSanPhamId,SoLuongMua,DonGiaMua,ThanhTien")] ChiTietHoaDon chiTietHoaDon)
        {
