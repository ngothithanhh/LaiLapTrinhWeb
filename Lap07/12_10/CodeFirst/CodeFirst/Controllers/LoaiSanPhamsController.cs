...
namespace CodeFirst.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MaLoai,TenLoai")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaLoai,TenLoai")] LoaiSanPham loaiSanPham)
        {
